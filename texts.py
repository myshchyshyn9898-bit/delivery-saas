...
TEXTS = {
    'uk': {
        ...
        'late_unassigned': 'Не призначено',
        'late_mins_msg': "Запізнення вже на {mins} хв!",
        'no_active_orders': "📭 Немає активних замовлень.",
        'order_already_closed': "⚠️ Замовлення вже закрите або скасоване.",
        'order_cancelled_admin': "❌ Замовлення <code>#{short_id}</code> скасовано адміністратором.",
        'order_taken_notify': "🛵 <b>{name}</b> взяв замовлення <code>#{short_id}</code>",
        'order_cancelled': "❌ Скасовано",
        'choose_lang': "🌐 Оберіть мову / Choose your language:",
        'lang_saved': "✅ Мову збережено!",
        'shift_on_duty': "🟢 <b>Зараз на зміні:</b>",
        'shift_active_line': "  🛵 <b>{name}</b> з {start_time} · {count} зам. · 💵 {cash} {cur}",
    ...
    'ru': {
        ...
        'late_unassigned': 'Не назначен',
        'late_mins_msg': "Опоздание уже на {mins} мин!",
        'no_active_orders': "📭 Нет активных заказов.",
        'order_already_closed': "⚠️ Заказ уже закрыт или отменён.",
        'order_cancelled_admin': "❌ Заказ <code>#{short_id}</code> отменён администратором.",
        'order_taken_notify': "🛵 <b>{name}</b> взял заказ <code>#{short_id}</code>",
        ...
        'shift_active_line': "  🛵 <b>{name}</b> с {start_time} · {count} зак. · 💵 {cash} {cur}",
        ...
        'late_unassigned': 'Nie przypisany',
        'late_mins_msg': "Spóźnienie już o {mins} min!",
        'no_active_orders': "📭 Brak aktywnych zamówień.",
        'order_already_closed': "⚠️ Zamówienie jest już zamknięte lub anulowane.",
        'order_cancelled_admin': "❌ Zamówienie <code>#{short_id}</code> anulowane przez administratora.",
        'order_taken_notify': "🛵 <b>{name}</b> przyjął zamówienie <code>#{short_id}</code>",
        'order_cancelled': "❌ Anulowano",
        'choose_lang': "🌐 Wybierz język / Choose your language:",
        'lang_saved': "✅ Język zapisany!",
        'shift_on_duty': "🟢 <b>Teraz na zmianie:</b>",
        'shift_active_line': "  🛵 <b>{name}</b> od {start_time} · {count} zam. · 💵 {cash} {cur}",
        ...
        'late_unassigned': 'Unassigned',
        'late_mins_msg': "Already {mins} min late!",
        'no_active_orders': "📭 No active orders.",
        'order_already_closed': "⚠️ Order is already closed or cancelled.",
        'order_cancelled_admin': "❌ Order <code>#{short_id}</code> cancelled by administrator.",
        'order_taken_notify': "🛵 <b>{name}</b> took order <code>#{short_id}</code>",
        'order_cancelled': "❌ Cancelled",
        'choose_lang': "🌐 Choose your language:",
        'lang_saved': "✅ Language saved!",
        'shift_on_duty': "Currently on shift:",
        'shift_active_line': "  🛵 <b>{name}</b> since {start_time} · {count} orders · 💵 {cash} {cur}",
