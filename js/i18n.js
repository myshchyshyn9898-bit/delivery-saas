...
var i18n = {
    'uk': {
        ...
        sal_base: 'Базова ЗП', btn_cancel: 'Скасувати', btn_close: 'Закрити',
        pos_token_saved_title: '✅ Токен збережено. Залишилось налаштувати Webhook:',
        pos_step1: 'Скопіюйте посилання нижче', pos_step2: 'У кабінеті каси відкрийте:',
        pos_step3: 'Вставте посилання та оберіть подію:', pos_step4: 'Збережіть — готово! 🎉',
        pos_copy_click: 'натисніть щоб скопіювати', pos_where_token: 'Де знайти токен?', pos_connecting: 'Підключити',
        pos_token_lbl_api: 'API Токен', pos_token_lbl_bearer: 'Bearer Токен', pos_token_lbl_auth: 'Authorization Token',
        pos_hint_poster: 'Знайдіть у кабінеті Poster: Налаштування → Інтеграції → API → Скопіюйте "API токен".',
        pos_hint_choice: 'Перейдіть у панель ChoiceQR: Settings → Integrations → Webhooks → згенеруйте Bearer Token.',
        pos_hint_gopos: 'Скопіюйте Authorization Token з адмін-панелі GoPOS: Ustawienia → Integracje → Tokeny.',
        pos_hint_syrve: 'Введіть API Login від системи Syrve (iiko) — знаходиться в налаштуваннях інтеграцій.',
        pos_event_poster: 'Нове замовлення доставки (incoming_order → added)',
        pos_step_poster: 'Налаштування → Інтеграції → Webhooks → Додати Webhook',
        title_sched_sal: 'Графік та зарплати', title_salary_team: 'Зарплати команди',
        tg_group_hint: 'Додайте бота в групу → надішліть будь-яке повідомлення → скопіюйте ID. Починається з',
        sal_courier_lbl: "КУР'ЄР", sal_kitchen_lbl: 'КУХНЯ', sal_admin_lbl: 'АДМІН',
        sched_btn_title: 'Графік роботи команди', sched_btn_sub: 'Перегляд та редагування розкладу',
        pos_copy_link: 'Скопіювати посилання', pos_copied: 'Скопійовано!',
        pos_paste_hint: 'Вставте посилання в налаштування каси.',
        pos_enter_token: 'Будь ласка, введіть токен.', pos_saving: 'Збереження...',
        pos_connected_lbl: 'Підключено', pos_not_connected: 'Не підключено',
        pos_token_saved: '✅ Токен збережено!', pos_token_hint: 'Тепер скопіюйте Webhook URL і вставте в касу.',
        pos_err_prefix: '❌ Помилка: ', pos_updating: 'Оновлення...',
        sal_no_staff: 'Персонал не знайдено', sal_no_data: 'Даних немає', sal_no_month_data: 'Немає даних за цей місяць',
        sal_admin: 'Адміністратор', sal_kitchen: 'Кухня', sal_per_order: 'За замовлення',
        sal_mileage: 'Пробіг', sal_bonus: 'Премія', sal_fine: 'Штраф',
        sal_hourly: 'Погодинна', sal_per_hour: '/год', sal_per_item: '/шт',
        sal_km_deduct: 'Вирахувати за км', sal_per_km: '/км',
        sal_paid: 'Виплачено', sal_unpaid: 'Не виплачено',
        sal_settings_title: 'Ставки та налаштування', sal_save_rates: 'Зберегти ставки',
        sal_shifts: 'Зміни', sal_hours: 'Години', sal_orders_col: 'Замовлення',
        sal_bonus_fine_adv: 'ПРЕМІЯ / ШТРАФ / АВАНС', sal_amount: 'Сума (-штраф)', sal_comment: 'Коментар',
        sal_add: 'Додати', sal_cancel_pay: 'Скасувати виплату', sal_pay: 'Виплатити',
        sal_rates_saved: '✅ Ставки збережено', sal_enter_amount: '❌ Введіть суму',
        sal_bonus_added: '✅ Премію додано', sal_pay_confirmed: '✅ Виплату підтверджено',
        sal_pay_cancelled: '↩️ Статус скасовано',
    ...
    'ru': {
        ...
        sal_base: 'Базовая ЗП', btn_cancel: 'Отмена', btn_close: 'Закрыть',
        pos_token_saved_title: '✅ Токен сохранён. Осталось настроить Webhook:',
        pos_step1: 'Скопируйте ссылку ниже', pos_step2: 'В кабинете кассы откройте:',
        pos_step3: 'Вставьте ссылку и выберите событие:', pos_step4: 'Сохраните — готово! 🎉',
        pos_copy_click: 'нажмите чтобы скопировать', pos_where_token: 'Где найти токен?', pos_connecting: 'Подключить',
        pos_token_lbl_api: 'API Токен', pos_token_lbl_bearer: 'Bearer Токен', pos_token_lbl_auth: 'Authorization Token',
        pos_hint_poster: 'Найдите в кабинете Poster: Настройки → Интеграции → API → Скопируйте "API токен".',
        pos_hint_choice: 'Перейдите в панель ChoiceQR: Settings → Integrations → Webhooks → сгенерируйте Bearer Token.',
        pos_hint_gopos: 'Скопируйте Authorization Token из панели GoPOS: Ustawienia → Integracje → Tokeny.',
        pos_hint_syrve: 'Введите API Login от системы Syrve (iiko) — находится в настройках интеграций.',
        pos_event_poster: 'Новый заказ доставки (incoming_order → added)',
        pos_step_poster: 'Настройки → Интеграции → Webhooks → Добавить Webhook',
        title_sched_sal: 'График и зарплаты', title_salary_team: 'Зарплаты команды',
        tg_group_hint: 'Добавьте бота в группу → отправьте любое сообщение → скопируйте ID. Начинается с',
        sal_courier_lbl: 'КУРЬЕР', sal_kitchen_lbl: 'КУХНЯ', sal_admin_lbl: 'АДМИН',
        sched_btn_title: 'График работы команды', sched_btn_sub: 'Просмотр и редактирование расписания',
        pos_copy_link: 'Скопировать ссылку', pos_copied: 'Скопировано!',
        pos_paste_hint: 'Вставьте ссылку в настройки кассы.',
        pos_enter_token: 'Пожалуйста, введите токен.', pos_saving: 'Сохранение...',
        pos_connected_lbl: 'Подключено', pos_not_connected: 'Не подключено',
        pos_token_saved: '✅ Токен сохранён!', pos_token_hint: 'Теперь скопируйте Webhook URL и вставьте в кассу.',
        pos_err_prefix: '❌ Ошибка: ', pos_updating: 'Обновление...',
        sal_no_staff: 'Персонал не найден', sal_no_data: 'Нет данных', sal_no_month_data: 'Нет данных за этот месяц',
        sal_admin: 'Администратор', sal_kitchen: 'Кухня', sal_per_order: 'За заказ',
        sal_mileage: 'Пробег', sal_bonus: 'Премия', sal_fine: 'Штраф',
        sal_hourly: 'Почасовая', sal_per_hour: '/ч', sal_per_item: '/шт',
        sal_km_deduct: 'Вычесть за км', sal_per_km: '/км',
        sal_paid: 'Выплачено', sal_unpaid: 'Не выплачено',
        sal_settings_title: 'Ставки и настройки', sal_save_rates: 'Сохранить ставки',
        sal_shifts: 'Смены', sal_hours: 'Часы', sal_orders_col: 'Заказы',
        sal_bonus_fine_adv: 'ПРЕМИЯ / ШТРАФ / АВАНС', sal_amount: 'Сумма (-штраф)', sal_comment: 'Комментарий',
        sal_add: 'Добавить', sal_cancel_pay: 'Отменить выплату', sal_pay: 'Выплатить',
        sal_rates_saved: '✅ Ставки сохранены', sal_enter_amount: '❌ Введите сумму',
        sal_bonus_added: '✅ Премия добавлена', sal_pay_confirmed: '✅ Выплата подтверждена',
        sal_pay_cancelled: '↩️ Статус отменён',
    ...
    'pl': {
        ...
        sal_base: 'Pensja podstawowa', btn_cancel: 'Anuluj', btn_close: 'Zamknij',
        pos_token_saved_title: '✅ Token zapisany. Pozostało skonfigurować Webhook:',
        pos_step1: 'Skopiuj link poniżej', pos_step2: 'W panelu kasy otwórz:',
        pos_step3: 'Wklej link i wybierz zdarzenie:', pos_step4: 'Zapisz — gotowe! 🎉',
        pos_copy_click: 'kliknij aby skopiować', pos_where_token: 'Gdzie znaleźć token?', pos_connecting: 'Połącz',
        pos_token_lbl_api: 'Token API', pos_token_lbl_bearer: 'Token Bearer', pos_token_lbl_auth: 'Token autoryzacyjny',
        pos_hint_poster: 'Znajdź w panelu Poster: Ustawienia → Integracje → API → Skopiuj "Token API".',
        pos_hint_choice: 'Przejdź do panelu ChoiceQR: Settings → Integrations → Webhooks → wygeneruj Bearer Token.',
        pos_hint_gopos: 'Skopiuj Authorization Token z panelu GoPOS: Ustawienia → Integracje → Tokeny.',
        pos_hint_syrve: 'Wprowadź API Login z systemu Syrve (iiko) — znajduje się w ustawieniach integracji.',
        pos_event_poster: 'Nowe zamówienie dostawy (incoming_order → added)',
        pos_step_poster: 'Ustawienia → Integracje → Webhooks → Dodaj Webhook',
        title_sched_sal: 'Harmonogram i wynagrodzenia', title_salary_team: 'Wynagrodzenia zespołu',
        tg_group_hint: 'Dodaj bota do grupy → wyślij dowolną wiadomość → skopiuj ID. Zaczyna się od',
        sal_courier_lbl: 'KURIER', sal_kitchen_lbl: 'KUCHNIA', sal_admin_lbl: 'ADMIN',
        sched_btn_title: 'Harmonogram pracy zespołu', sched_btn_sub: 'Przeglądaj i edytuj harmonogram',
        pos_copy_link: 'Skopiuj link', pos_copied: 'Skopiowano!',
        pos_paste_hint: 'Wklej link w ustawienia kasy.',
        pos_enter_token: 'Proszę wpisać token.', pos_saving: 'Zapisywanie...',
        pos_connected_lbl: 'Połączono', pos_not_connected: 'Niepołączono',
        pos_token_saved: '✅ Token zapisany!', pos_token_hint: 'Teraz skopiuj Webhook URL i wklej do kasy.',
        pos_err_prefix: '❌ Błąd: ', pos_updating: 'Aktualizacja...',
        sal_no_staff: 'Brak personelu', sal_no_data: 'Brak danych', sal_no_month_data: 'Brak danych za ten miesiąc',
        sal_admin: 'Administrator', sal_kitchen: 'Kuchnia', sal_per_order: 'Za zamówienie',
        sal_mileage: 'Przebieg', sal_bonus: 'Premia', sal_fine: 'Kara',
        sal_hourly: 'Godzinowa', sal_per_hour: '/godz', sal_per_item: '/szt',
        sal_km_deduct: 'Odlicz za km', sal_per_km: '/km',
        sal_paid: 'Wypłacono', sal_unpaid: 'Nie wypłacono',
        sal_settings_title: 'Stawki i ustawienia', sal_save_rates: 'Zapisz stawki',
        sal_shifts: 'Zmiany', sal_hours: 'Godziny', sal_orders_col: 'Zamówienia',
        sal_bonus_fine_adv: 'PREMIA / KARA / ZALICZKA', sal_amount: 'Kwota (-kara)', sal_comment: 'Komentarz',
        sal_add: 'Dodaj', sal_cancel_pay: 'Anuluj wypłatę', sal_pay: 'Wypłać',
        sal_rates_saved: '✅ Stawki zapisane', sal_enter_amount: '❌ Wprowadź kwotę',
        sal_bonus_added: '✅ Premia dodana', sal_pay_confirmed: '✅ Wypłata potwierdzona',
        sal_pay_cancelled: '↩️ Status anulowany',
    ...
    'en': {
        ...
        sal_base: 'Base salary', btn_cancel: 'Cancel', btn_close: 'Close',
        pos_token_saved_title: '✅ Token saved. Now set up Webhook:',
        pos_step1: 'Copy the link below', pos_step2: 'In your POS dashboard open:',
        pos_step3: 'Paste the link and select the event:', pos_step4: 'Save — done! 🎉',
        pos_copy_click: 'click to copy', pos_where_token: 'Where to find the token?', pos_connecting: 'Connect',
        pos_token_lbl_api: 'API Token', pos_token_lbl_bearer: 'Bearer Token', pos_token_lbl_auth: 'Authorization Token',
        pos_hint_poster: 'Find in Poster dashboard: Settings → Integrations → API → Copy "API token".',
        pos_hint_choice: 'Go to ChoiceQR panel: Settings → Integrations → Webhooks → generate Bearer Token.',
        pos_hint_gopos: 'Copy Authorization Token from GoPOS panel: Ustawienia → Integracje → Tokeny.',
        pos_hint_syrve: 'Enter API Login from Syrve (iiko) — found in integration settings.',
        pos_event_poster: 'New delivery order (incoming_order → added)',
        pos_step_poster: 'Settings → Integrations → Webhooks → Add Webhook',
        title_sched_sal: 'Schedule & salaries', title_salary_team: 'Team salaries',
        tg_group_hint: 'Add the bot to the group → send any message → copy the ID. Starts with',
        sal_courier_lbl: 'COURIER', sal_kitchen_lbl: 'KITCHEN', sal_admin_lbl: 'ADMIN',
        sched_btn_title: 'Team work schedule', sched_btn_sub: 'View and edit the schedule',
        pos_copy_link: 'Copy link', pos_copied: 'Copied!',
        pos_paste_hint: 'Paste the link into your POS settings.',
        pos_enter_token: 'Please enter a token.', pos_saving: 'Saving...',
        pos_connected_lbl: 'Connected', pos_not_connected: 'Not connected',
        pos_token_saved: '✅ Token saved!', pos_token_hint: 'Now copy the Webhook URL and paste into your POS.',
        pos_err_prefix: '❌ Error: ', pos_updating: 'Updating...',
        sal_no_staff: 'No staff found', sal_no_data: 'No data', sal_no_month_data: 'No data for this month',
        sal_admin: 'Administrator', sal_kitchen: 'Kitchen', sal_per_order: 'Per order',
        sal_mileage: 'Mileage', sal_bonus: 'Bonus', sal_fine: 'Fine',
        sal_hourly: 'Hourly', sal_per_hour: '/hr', sal_per_item: '/pcs',
        sal_km_deduct: 'Deduct per km', sal_per_km: '/km',
        sal_paid: 'Paid', sal_unpaid: 'Not paid',
        sal_settings_title: 'Rates & settings', sal_save_rates: 'Save rates',
        sal_shifts: 'Shifts', sal_hours: 'Hours', sal_orders_col: 'Orders',
        sal_bonus_fine_adv: 'BONUS / FINE / ADVANCE', sal_amount: 'Amount (-fine)', sal_comment: 'Comment',
        sal_add: 'Add', sal_cancel_pay: 'Cancel payment', sal_pay: 'Pay',
        sal_rates_saved: '✅ Rates saved', sal_enter_amount: '❌ Enter amount',
        sal_bonus_added: '✅ Bonus added', sal_pay_confirmed: '✅ Payment confirmed',
        sal_pay_cancelled: '↩️ Status cancelled',
