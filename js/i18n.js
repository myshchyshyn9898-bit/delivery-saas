...
var i18n = {
    'uk': {
        ...
        pos_copy_click: 'натисніть щоб скопіювати',
        ...
        pos_where_token: 'Де знайти токен?', pos_connecting: 'Підключити',
        ...
        sal_no_staff: 'Персонал не знайдено', sal_no_data: 'Даних немає',
        sal_no_month_data: 'Немає даних за цей місяць',
        ...
        sal_bonus_fine_adv: 'ПРЕМІЯ / ШТРАФ / АВАНС',
        sal_amount: 'Сума (-штраф)', sal_comment: 'Коментар',
    ...
    'ru': {
        ...
        pos_copy_click: 'нажмите чтобы скопировать',
        pos_token_lbl_api: 'API Токен', pos_token_lbl_bearer: 'Bearer Токен', pos_token_lbl_auth: 'Authorization Token',
        ...
        pos_where_token: 'Где найти токен?', pos_connecting: 'Подключить',
        ...
        sal_no_staff: 'Персонал не найден', sal_no_data: 'Нет данных',
        sal_no_month_data: 'Нет данных за этот месяц',
        ...
        sal_bonus_fine_adv: 'ПРЕМИЯ / ШТРАФ / АВАНС',
        sal_amount: 'Сумма (-штраф)', sal_comment: 'Комментарий',
    ...
    'pl': {
        ...
        pos_copy_click: 'kliknij aby skopiować',
        ...
        pos_where_token: 'Gdzie znaleźć token?', pos_connecting: 'Połącz',
        ...
        sal_no_staff: 'Brak personelu', sal_no_data: 'Brak danych',
        sal_no_month_data: 'Brak danych za ten miesiąc',
        ...
        sal_bonus_fine_adv: 'PREMIA / KARA / ZALICZKA',
        sal_amount: 'Kwota (-kara)', sal_comment: 'Komentarz',
    ...
    'en': {
        ...
        pos_where_token: 'Where to find the token?', pos_connecting: 'Connect',
        ...
        sal_no_staff: 'No staff found', sal_no_data: 'No data',
        sal_no_month_data: 'No data for this month',
        ...
        sal_bonus_fine_adv: 'BONUS / FINE / ADVANCE',
        sal_amount: 'Amount (-fine)', sal_comment: 'Comment',
