...
var i18n = {
    'uk': {
        ...
        err_server_unavail: 'Сервер недоступний. Спробуйте пізніше.',
        err_config: 'Помилка конфігурації. Зверніться до підтримки.',
        err_cold_start: '⏳ Сервер не відповідає. Зачекайте 15 секунд і оновіть.',
        err_connection: 'Помилка з’єднання: ',
        err_no_biz: 'Заклад не знайдено. Перевірте посилання або зверніться до підтримки.',
        err_load_data: 'Помилка завантаження даних: ',
        err_open_bot: 'Відкрийте дашборд через бота DeliPro.',
        btn_retry: '🔄 Спробувати знову',
        err_uber_no_group: '⚠️ Для режиму Вільна каса потрібно вказати ID Telegram-групи кур’єрів.',
        toast_sub_ending: '⚠️ Підписка скоро закінчується',
        pos_copy_link: 'Скопіювати посилання',
        pos_copied: 'Скопійовано!', pos_paste_hint: 'Вставте посилання в налаштування каси.',
    ...
    'ru': {
        ...
        err_server_unavail: 'Сервер недоступен. Попробуйте позже.',
        err_config: 'Ошибка конфигурации. Обратитесь в поддержку.',
        err_cold_start: '⏳ Сервер не отвечает. Подождите 15 секунд и обновите.',
        err_connection: 'Ошибка соединения: ',
        err_no_biz: 'Заведение не найдено. Проверьте ссылку или обратитесь в поддержку.',
        err_load_data: 'Ошибка загрузки данных: ', err_open_bot: 'Откройте дашборд через бота DeliPro.',
        btn_retry: '🔄 Попробовать снова',
        err_uber_no_group: '⚠️ Для режима Свободная касса нужен ID группы курьеров.',
        toast_sub_ending: '⚠️ Подписка скоро закончится',
    ...
    'pl': {
        ...
        err_server_unavail: 'Serwer niedostępny. Spróbuj później.',
        err_config: 'Błąd konfiguracji. Skontaktuj się z pomocą.',
        err_cold_start: '⏳ Serwer nie odpowiada. Poczekaj 15 sekund i odśwież.',
        err_connection: 'Błąd połączenia: ', err_no_biz: 'Lokal nie znaleziony. Sprawdź link.',
        err_load_data: 'Błąd ładowania danych: ', err_open_bot: 'Otwórz dashboard przez bota DeliPro.',
        btn_retry: '🔄 Spróbuj ponownie',
        err_uber_no_group: '⚠️ Dla trybu Wolna kasa musisz podać ID grupy Telegram kurierów.',
        toast_sub_ending: '⚠️ Subskrypcja wkrótce wygaśnie',
    ...
    'en': {
        ...
        err_server_unavail: 'Server unavailable. Try again later.',
        err_config: 'Config error. Contact support.',
        err_cold_start: '⏳ Server not responding. Wait 15 seconds and reload.',
        err_connection: 'Connection error: ', err_no_biz: 'Business not found. Check the link or contact support.',
        err_load_data: 'Data load error: ', err_open_bot: 'Open the dashboard via DeliPro bot.',
        btn_retry: '🔄 Try again',
        err_uber_no_group: '⚠️ For Free queue mode you must provide the couriers Telegram group ID.',
        toast_sub_ending: '⚠️ Subscription ending soon',
