...
var i18n = {
    ...
    'en': {
        ...
        err_no_biz: 'Business not found. Check the link or contact support.',
        err_load_data: 'Data load error: ',
        err_open_bot: 'Open the dashboard via DeliPro bot.',
        btn_retry: '🔄 Try again',
        ...
        err_no_tg_id_full: 'Error: could not identify your Telegram ID. Try opening via Telegram.',
        pos_connecting: 'Connect',
        pos_copy_link: 'Copy link',
        pos_copied: 'Copied!',
        pos_paste_hint: 'Paste the link into your POS settings.',
        pos_enter_token: '📍 Please enter a token.',
        pos_saving: 'Saving...',
        pos_connected_lbl: 'Connected',
        pos_token_saved: '✅ Token saved!',
        pos_token_hint: 'Now copy the Webhook URL and paste into your POS.',
        pos_err_prefix: '❌ Error: ',
        pos_updating: 'Updating...',
        sal_no_staff: 'No staff found',
        sal_no_data: 'No data',
        sal_no_month_data: 'No data for this month',
        sal_admin: 'Administrator',
        sal_kitchen: 'Kitchen',
        sal_base: 'Base salary',
        sal_per_order: 'Per order',
        sal_mileage: 'Mileage',
        sal_bonus: 'Bonus',
        sal_fine: 'Fine',
        sal_hourly: 'Hourly',
        sal_per_hour: '/hr',
        sal_per_item: '/pcs',
        sal_km_deduct: 'Deduct per km',
        sal_per_km: '/km',
        sal_paid: 'Paid',
        sal_unpaid: 'Not paid',
        sal_settings_title: 'Rates & settings',
        sal_save_rates: 'Save rates',
        sal_shifts: 'Shifts',
        sal_hours: 'Hours',
        sal_orders_col: 'Orders',
        sal_bonus_fine_adv: 'BONUS / FINE / ADVANCE',
        sal_amount: 'Amount (-fine)',
        sal_comment: 'Comment',
        sal_add: 'Add',
        sal_cancel_pay: 'Cancel payment',
        sal_pay: 'Pay',
        sal_rates_saved: '✅ Rates saved',
        sal_enter_amount: '❌ Enter amount',
        sal_bonus_added: '✅ Bonus added',
        sal_pay_confirmed: '✅ Payment confirmed',
